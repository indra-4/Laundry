                ...
                <form method="POST" action="{{ route('pemilik.layanan.store') }}">
                    ...
                    <div class="mb-3" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <select name="jenis" class="form-select @error('jenis') is-invalid @enderror" 
                            ...
                            <option value="express" {{ old('jenis') == 'express' ? 'selected' : '' }}>Express</option>
                        </select>
                        @error('jenis')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3" id="harga-kg-section" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="mb-3" id="harga-satuan-section" style="display: none;" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="mb-3" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <input type="number" name="durasi_pengerjaan" 
                               ...
                               value="{{ old('durasi_pengerjaan', 3) }}" required>
                    ...
                    <div class="mb-3" data-aos="fade-up" data-aos-delay="600">
                        <div class="form-check">
                            <input type="checkbox" name="status_aktif" value="1" 
                                   class="form-check-input" id="status_aktif" checked>
                            <label class="form-check-label" for="status_aktif">Aktifkan layanan</label>
                        </div>
                    </div>
                    
                    <div class="d-grid gap-2" data-aos="fade-up" data-aos-delay="700">
