    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    <i class="bi bi-chat-dots"></i> Chat dengan {{ $pesanan->pelanggan->nama }}
                </h5>
                <a href="{{ route('kurir.chat.index') }}" class="btn btn-sm btn-secondary">
            ...
            <div class="card-body">
                ...
                <form id="chat-form" method="POST" action="{{ route('kurir.chat.store', $pesanan->pesanan_id) }}">
                    @csrf
...
<script>
    ...
    setInterval(function() {
        fetch('{{ route("kurir.chat.show", $pesanan->pesanan_id) }}')
