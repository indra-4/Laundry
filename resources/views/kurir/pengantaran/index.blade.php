...
@section('page-title', 'Daftar Pengantaran')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-box-arrow-up"></i> Daftar Pengantaran</h5>
    </div>
    <div class="card-body">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($p->tanggal_antar)
                                {{ $p->tanggal_antar->format('d/m/Y H:i') }}
                            @else
                    ...
                    <tr>
                        <td colspan="7" class="text-center text-muted py-4">
                            <i class="bi bi-inbox"></i> Tidak ada pengantaran
                        </td>
                    </tr>
                    @endforelse
                </tbody>
